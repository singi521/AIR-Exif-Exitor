...
:: Android packaging
set AND_CERT_NAME="AIR_EXIF_EDITOR"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AIREXIFEDITOR.p12
...
set IOS_PROVISION=cert\AIREXIFEDITOR.mobileprovision
...
set APP_ID=air.AIREXIFEDITOR

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AIREXIFEDITOR
